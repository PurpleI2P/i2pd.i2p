	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%">
		<tr>
			<td align=center>
				...
				<a href="http://fh5r3hlkkwh7udtjeqmekmq4qd62jnjqmnqob5hm3ndiuo6lauza.b32.i2p/projects/bonobonet/" target="_blank" title="BonoboNet"><img src="img/bnet_ilita.png" width="88px" height="31px" alt="bonobonet.i2p"></a>
				...
				<br>
				<a href="http://animal.i2p/" target="_blank" title="Современная фауна"><img src="img/animal.png" width="88px" height="31px" alt="animal.i2p"></a>	
				<a href="http://notbob.i2p/" target="_blank" title="Список и статистика eepsite-ов"><img src="img/notbob.jpg" width="88px" height="31px" alt="notbob.i2p"></a>
				...
				<a href="http://irc.acetone.i2p/web/#ru" target="_blank" title="Веб-морда ILITA IRC"><img src="img/irc-acetone.jpg" alt="irc.acetone.i2p"></a>
				<br>
